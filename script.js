...
let contentfont
function preload() {
    contentfont = loadFont('font/Unkempt-Bold.ttf');
   musicalfont= loadFont('font/musicfont.otf')
    circlecolor = color(255, 255, 255, 255);
    keyaudioJazz = 'audio/jazz/piano jazz.wav';
    drumaudioJazz = 'audio/jazz/drum jazz.wav';
    violinaudioJazz = 'audio/jazz/violin jazz.wav';
    hornaudioJazz = 'audio/jazz/horn jazz.wav';

    
    keyaudioHiphop = 'audio/hiphop/key hiphop.wav';
    drumaudioHiphop = 'audio/hiphop/drum hiphop.wav';
    violinaudioHiphop = 'audio/hiphop/violin hiphop.wav';
    hornaudioHiphop = 'audio/hiphop/horn hiphop.wav'
    popsound=loadSound('audio/pop.mp3')
    vinylscratchsound= loadSound('audio/vinyl scratch.mp3')
    ...
    radio = loadImage('images/radio round.png');
    grammy = loadImage('images/grammy.png');
    keyImg = loadImage('images/key sticker jazz.png');
    drumImg = loadImage('images/drum sticker jazz.png');
    hornImg = loadImage('images/horn sticker jazz.png');
    violinImg = loadImage('images/violin sticker jazz.png');
    muteImg = loadImage('images/mute.png');
    speakerImg = grammy;
    hiphopbackgound = loadImage('images/hiphop background.png')
}
...
function keyPressed() {
    ...
    if (currentKeyAudio === keyaudioHiphop) {
        keyImg = loadImage('images/key sticker.png');
        drumImg = loadImage('images/drum sticker.png');
        hornImg = loadImage('images/horn sticker.png')
        violinImg = loadImage('images/violin sticker.png')
